...
boxes = [
  ...
  {:name => 'centos6-capsule', :shell_args => "#{install_shell} centos6 --capsule"}.merge(base_boxes[:centos6]),
  ...
  {:name => 'centos7-capsule', :shell_args => "#{install_shell} centos7 --capsule"}.merge(base_boxes[:centos7]),
